...
def main():
    ...
    parser.add_argument(
        '--project',
        type=str,
        help='optional: specify the project name to replace %project% [default:vgcl] <agave, vgcl>'
    )
    ...
    project = args.project if args.project is not None else "vgcl"
    if project == "agave":
        new_license = new_license.replace('%project%', "Agave - A lightweight web browser engine")
    else:
        new_license = new_license.replace('%project%', "VGCL - Vector Graphics Component Library")
