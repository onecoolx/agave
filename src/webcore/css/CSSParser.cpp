    ...
    , m_floatingMediaQueryExpList(0)
{
    ...
    m_floatingSelectors = new HashSet<CSSSelector*>;
    m_floatingValueLists = new HashSet<ValueList*>;
    m_floatingFunctions = new HashSet<Function*>;
}
...
CSSParser::~CSSParser()
{
    ...
    delete m_floatingSelectors;
    delete m_floatingValueLists;
    delete m_floatingFunctions;
}
...
bool CSSParser::validUnit(Value* value, Units unitflags, bool strict)
{
    ...
    case CSSPrimitiveValue::CSS_NUMBER:
        b = (unitflags & FNumber)?true:false;
    ...
    case CSSPrimitiveValue::CSS_PERCENTAGE:
        b = (unitflags & FPercent)?true:false;
        break;
    case Value::Q_EMS:
    ...
    case CSSPrimitiveValue::CSS_PC:
        b = (unitflags & FLength)?true:false;
        break;
    case CSSPrimitiveValue::CSS_MS:
    case CSSPrimitiveValue::CSS_S:
        b = (unitflags & FTime)?true:false;
        break;
    case CSSPrimitiveValue::CSS_DEG:
    case CSSPrimitiveValue::CSS_RAD:
    case CSSPrimitiveValue::CSS_GRAD:
        b = (unitflags & FAngle) ? true : false;
        break;
