...
bool RenderObject::requiresLayer()
{
    return isRoot() || isPositioned() || isRelPositioned() || isTransparent()
        || hasOverflowClip() || style()->hasBlendMode() || style()->hasClipPath();
}
    ...
    if (renderTop) {
        ...
        if (renderRadii) {
            ...
            if (topRight.width()) {
                ...
                drawBorderArc(graphicsContext, rightX-1, leftY, thickness, topRight, secondAngleStart, secondAngleSpan,
    ...
    if (renderBottom) {
        ...
        if (renderRadii) {
            ...
            if (bottomLeft.width()) {
                ...
                // Draw lower left arc
                drawBorderArc(graphicsContext, leftX, leftY-1, thickness, bottomLeft, firstAngleStart, firstAngleSpan,
            ...
            if (bottomRight.width()) {
                ...
                drawBorderArc(graphicsContext, rightX-1, rightY-1, thickness, bottomRight, secondAngleStart, secondAngleSpan,
