...
{
    static HashMap<Document*, RequestsSet*> *map = new HashMap<Document*, RequestsSet*>;
    return map;
}
...
{
    static HashSet<String, CaseInsensitiveHash<String> > *forbiddenHeaders = new HashSet<String, CaseInsensitiveHash<String> >;
