...
private:
    ...
    public:
        ...
        bool inAnySpecial() const { return (m_bits & (InScript | InStyle | InXmp | InTextArea | InTitle))?true:false; }
        bool hasTagState() const { return (m_bits & TagMask)?true:false; }
        bool hasEntityState() const { return (m_bits & EntityMask)?true:false; }

        bool needsSpecialWriteHandling() const { return (m_bits & (InScript | InStyle | InXmp | InTextArea | InTitle | TagMask | EntityMask | InPlainText | InComment | InServer | InProcessingInstruction | StartTag))?true:false; }
    ...
    private:
        ...
        bool testBit(StateBits bit) const { return (m_bits & bit)?true:false; }
    ...
    Deque<CachedScript*> pendingScripts;
