...
#if MOBILE
static const int cDefaultCacheCapacity = 4096 * 1024;
#else
static const int cDefaultCacheCapacity = 8192 * 1024;
#endif
static const double cMinDelayBeforeLiveDecodedPrune = 1; // Seconds.
#if MOBILE
static const float cTargetPrunePercentage = .90f; // Percentage of capacity toward which we prune, to avoid immediately pruning again.
#else
...
void Cache::adjustSize(bool live, unsigned delta)
{
    if (live) {
