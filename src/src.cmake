...
file(GLOB_RECURSE SOURCES ${PROJ_ROOT}/src/wtf/*.cpp
                          ${PROJ_ROOT}/src/webview/*.cpp
                          ${PROJ_ROOT}/src/webcore/css/*.cpp
...
#    ${PROJ_ROOT}/src/webcore/buildQJS/QJSHTMLInputElementBaseTable.cpp
#)
...
add_library(${LIB_NAME} ${KJS_SOURCES} ${QJS_SOURCES} ${SOURCES})
...
#if (OPT_USE_QJS)
    #target_link_libraries(${LIB_NAME} PRIVATE libquickjs.a)
#endif()
