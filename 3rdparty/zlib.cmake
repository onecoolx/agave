...
if(CMAKE_BUILD_TYPE STREQUAL "Debug")
    set(ZLIB_STATIC_LIB_TYPE "d")
endif()
set_target_properties(z PROPERTIES
  IMPORTED_LOCATION ${PROJ_OUT}/lib/${CMAKE_STATIC_LIBRARY_PREFIX}${ZLIB_NAME}static${ZLIB_STATIC_LIB_TYPE}${CMAKE_STATIC_LIBRARY_SUFFIX}
)
else()
set_target_properties(z PROPERTIES
