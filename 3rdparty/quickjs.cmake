...
ExternalProject_Add(
  ...
  BUILD_IN_SOURCE
  CMAKE_ARGS -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} -DCMAKE_INSTALL_PREFIX=${PROJ_OUT} -DCMAKE_C_COMPILER=${CMAKE_C_COMPILER}
)
else()
ExternalProject_Add(
  ${QJS_NAME}
  ...
  BUILD_IN_SOURCE
  CMAKE_ARGS -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} -DCMAKE_INSTALL_PREFIX=${PROJ_OUT} -DCMAKE_C_COMPILER=${CMAKE_C_COMPILER} -DCMAKE_INTERPROCEDURAL_OPTIMIZATION=OFF
)
endif()
