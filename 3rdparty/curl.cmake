...
ExternalProject_Add(
  ...
  BUILD_IN_SOURCE
  CMAKE_ARGS -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} -DBUILD_SHARED_LIBS=ON -DBUILD_STATIC_LIBS=OFF -DBUILD_CURL_EXE=OFF -DCURL_USE_MBEDTLS=ON -DCMAKE_INSTALL_PREFIX=${PROJ_OUT} -DMBEDTLS_INCLUDE_DIRS=${PROJ_OUT}/include
)
...
set_target_properties(curl PROPERTIES
  IMPORTED_LOCATION ${PROJ_OUT}/lib/${CMAKE_SHARED_LIBRARY_PREFIX}curl${CMAKE_SHARED_LIBRARY_SUFFIX}
)
