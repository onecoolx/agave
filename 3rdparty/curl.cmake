...
ExternalProject_Add(
  ...
  BUILD_IN_SOURCE
  CMAKE_ARGS -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} -DCMAKE_C_FLAGS=-fPIC -DBUILD_SHARED_LIBS=OFF -DBUILD_STATIC_LIBS=ON -DBUILD_CURL_EXE=OFF -DCURL_USE_MBEDTLS=ON -DCMAKE_INSTALL_PREFIX=${PROJ_OUT} -DMBEDTLS_INCLUDE_DIRS=${PROJ_OUT}/include
)
