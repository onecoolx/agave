...
ExternalProject_Add(
  ...
  BUILD_IN_SOURCE
  CMAKE_ARGS -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} -DCMAKE_C_FLAGS=-fPIC -DBUILD_SHARED_LIBS=OFF -DLIBXSLT_WITH_DEBUGGER=OFF -DLIBXSLT_WITH_PYTHON=OFF -DLIBXSLT_WITH_PROGRAMS=OFF -DLIBXSLT_WITH_TESTS=OFF -DLIBXSLT_WITH_XSLT_DEBUG=OFF -DCMAKE_INSTALL_PREFIX=${PROJ_OUT} -DLIBXML2_INCLUDE_DIRS=${PROJ_OUT}/include/libxml2
)
