...
if(CMAKE_BUILD_TYPE STREQUAL "Debug")
    set(XSLT_STATIC_LIB_TYPE "d")
endif()
add_library(xslt STATIC IMPORTED)
set_target_properties(xslt PROPERTIES
  IMPORTED_LOCATION ${PROJ_OUT}/lib/libxslts${XSLT_STATIC_LIB_TYPE}${CMAKE_STATIC_LIBRARY_SUFFIX}
  INTERFACE_COMPILE_DEFINITIONS LIBXSLT_STATIC
)

add_library(exslt STATIC IMPORTED)
set_target_properties(exslt PROPERTIES
  IMPORTED_LOCATION ${PROJ_OUT}/lib/libexslts${XSLT_STATIC_LIB_TYPE}${CMAKE_STATIC_LIBRARY_SUFFIX}
  INTERFACE_COMPILE_DEFINITIONS LIBXSLT_STATIC
)
else()
add_library(xslt STATIC IMPORTED)
